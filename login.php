...
<head>
    ...
    <title>ExtremeSports Gear | Login</title>
    <meta name="description" content="Login to access your account at ExtremeSports Gear">
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1>Login</h1>
                <p>Access your ExtremeSports Gear account</p>
            </div>
        </section>
